    ...
    children: [
      Container(
        ...
        decoration: BoxDecoration(
            color: theme.primaryColor, borderRadius: BorderRadius.circular(6)),
        child: Column(
          children: [
            Container(
              ...
              child: Container(
                  ...
                  child: Consumer<DashboardController>(
                    builder: (context, value, child) {
                      return value.selecteddepartement == ""
                          ? const SizedBox()
                          : FutureBuilder<
                              DocumentSnapshot<Map<String, dynamic>>>(
                              future: FirebaseTitle()
                                  .getTitle(value.selecteddepartement),
                              builder: (context, snapshot) {
                                ...
                                Departement data = Departement.fromJson(
                                    snapshot.data!.data()!);
                                data.title!.sort(
                                  (a, b) {
